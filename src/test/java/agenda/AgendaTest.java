...
public class AgendaTest {
    ...
    Event simple2 = new Event("Simple event 2", nov_2__2020_22_30, min_120);
    ...
    public void testFindTitle(){
        ...
        assertFalse(agenda.findByTitle("evenement").contains(simple2));
    }
    ...
    public void testIsFree(){
        ...
        assertTrue(agenda.isFreeFor(simple2), "L'évènement doit avoir lieu");
    }
